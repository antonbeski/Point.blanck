...
st.markdown("""
Point blanck provides stock market data, analysis, and predictive tools for **educational and informational purposes only**.  

- Point blanck does **not** provide financial, investment, trading, or legal advice.  
